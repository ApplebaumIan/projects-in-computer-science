...
sidebar_custom_props:
    icon: blocks
    affordanceText: "Learn about the basic structure of an OpenAPI definition"
---
...
This section is included here for instructional clarity. Students are encouraged to consult the official specification for full details.
:::
