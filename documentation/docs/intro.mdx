...
<div style={{float:"right", marginTop:"5px", marginRight:"15px", marginBottom:"5px"}}>
    ...
    <img src="/img/blastpad-example.png"  alt="Blastpad Example" style={{marginTop:"5px", marginLeft:"15px", marginBottom:"5px", maxWidth:"400px"}} />
</Figure>
</div>
...
<Figure id="codespaces-example" src="/img/codespaces.gif" caption={<a href="https://docs.github.com/en/codespaces">GitHub Codespaces</a>} subcaption={<p>Preview and edit your docs in your web browser, no complicated install.</p>}/>
