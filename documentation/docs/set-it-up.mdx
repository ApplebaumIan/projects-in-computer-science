...
export const githubClassroomLink =
  typeof window !== 'undefined' && window.location.hostname === 'capstone.ianapplebaum.com'
    ? "https://classroom.github.com/a/g1vGIH_d"
    : "https://classroom.github.com/a/YOUR_OTHER_CLASSROOM_ID";
...
1. <a href={githubClassroomLink}>Click here to join the GitHub Classroom and get the starter project</a>.
