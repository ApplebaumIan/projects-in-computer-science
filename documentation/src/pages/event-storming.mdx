...
[Join the Zoom meeting](https://temple.zoom.us/j/98090966515)<br/>
...
<Figure caption={"Event Storming Presentaion"} subcaption={
    ...
    <iframe height={"500"} width={"100%"} src="/event-storming-keynote" title="W3Schools Free Online Web Tutorials" loading="lazy"></iframe>
</Figure>
...
<iframe width="768" height="432" src="https://miro.com/app/live-embed/uXjVPtOqBHI=/?moveToViewport=-19794,-9302,6397,3556&embedId=631810532039" frameborder="0" scrolling="no" allow="fullscreen; clipboard-read; clipboard-write" allowfullscreen loading="lazy"></iframe>
...
![Discover events](../../static/img/event_discovery.webp)
...
![Enforce Timeline](../../static/img/enforce_timeline.webp)
