...
<Figure caption={"Vehicle Collision Automatic Detection Final Demo"}>
    <iframe width="560" height="315" src="https://www.youtube.com/embed/Wx4h5qCqgfw?si=I8vlm0Dmj_vWL_NQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
