...
The Project Abstract will be at least 1⁄2 page, but not more than one-page long. A page is defined as an 81⁄2" × 11" with 1" margins containing 11-point single-spaced text. The Project Abstract will contain.
