...
- Monday, 2:30-4:00 PM
- Tuesday and Thursday, 1-2:00 PM
...
Kyle Dragon Lee: Kyle.d.lee@temple.edu Office hours: TBA
...
**Attendance to both lab and lecture is mandatory**, especially working on a project in a sizable team in this course. We will implement Qwickly in Canvas to keep track students’ attendance. Unexcused absence will not only affect your personal performance, but also the team’s performance. As a result, it will be in reduction of final grades. Please attend all lecture and lab sessions on time. If you cannot make a class for any reason, please inform the other team members of your project and me ahead of time as a courtesy.
Please turn your mobile phone in vibrating mode during the class session.

:::danger working a fulltime job

Tell your manager that you cant work during this class. This class is highly interactive and requires your full attention, especially when we start to the project. I expect that since you registered for this course that you can fully participate. If you cannot interact, give presentations, turn on your camera, or talk to your teammates during Lab/Lecture please withdraw from this course. 
...
You may discuss project assignments with your friends, but everyone must write up his/her own solutions. Furthermore, you must write the names of your collaborators on the front page of the assignment, or in the comments in the code, e.g. I discussed this with Peter and Sally.
Using open source code is allowed and encouraged. You are responsible for strictly abide by the open source license agreement if your project implementation includes any open source software code.

Sharing your code, design specification and other documents in the capstone with other students in class project is permitted and encouraged. If you receive help from other students concerning the solution of your project implementation, the nice and the proper thing to do is recognize that help in writing in your design documents or in your source code as comments, e.g. I discussed this with Peter and Sally. If you copy someone else code, you must cite where it come from.
...
Describe the initial design concept: Hardware/software architecture, programming language, operating system, et
