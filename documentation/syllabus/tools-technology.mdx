              ...
              <Figure
                  ...
                  caption={
                      <a href="https://capstone-projects-2024-spring.github.io/project-blastpad/" >
                          <p style={{
                              marginTop: '25px',
                          }}>Project BlastPad Spring 2024</p>
                      </a>
                  }
                  subcaption={
                      <><p>Example of a previous capstone project&#39;s <br/> Docusaurus-powered documentation site</p> <button onClick={()=>{
                            window.location.href = '/showcase';
                      }} className="button button--small button--primary button--outline" style={{marginTop: '10px'}}>
                              More examples in Project Showcase ⭐️
                        </button>
                      </>
